...
export function CTA() {
  return (
    <section className="py-32 px-6 border-t border-surface-border">
      <div className="max-w-4xl mx-auto text-center">
        <h2 className="font-display text-4xl sm:text-5xl md:text-6xl leading-tight mb-6">
          Stop being the
          <br />
          <span className="text-accent">on-call hero.</span>
        </h2>
        <p className="text-muted text-lg max-w-2xl mx-auto mb-10">
          Deploy ops-phoenix today and let your next incident resolve itself
          while you sleep.
        </p>
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <a
            ...
            className="inline-flex items-center gap-2 px-8 py-3.5 bg-accent text-background font-semibold rounded-full hover:bg-accent-soft transition-colors"
          >
            <svg
              width="18"
              height="18"
